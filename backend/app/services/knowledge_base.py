...
TAG_TO_FILE: dict[str, str] = {
    ...
    "recupero_notturno": "sleep_and_recovery.md",
    "tecniche_intensita": "advanced_techniques_efficiency.md",
    "allenamento_breve": "advanced_techniques_efficiency.md",
    "pausa_allenamento": "detraining_and_return.md",
    "ripresa": "detraining_and_return.md",
    "attivazione_muscolare": "muscle_activation_emg.md",
    "emg": "muscle_activation_emg.md",
    "donne": "women_training_menstrual_cycle.md",
    "ciclo_mestruale": "women_training_menstrual_cycle.md",
    # Nutrizione
